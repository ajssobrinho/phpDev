...
<span style="font-size:1.7em;"><b>Bids a aprovar</b></span><hr />

<span style="line-height:40%;">
<?php 	
	$leiloes = new leiloes ();
	$dado = $leiloes->verLeiloesStandby();
...
<a href="leiloes_aprovar.php?cod_leilao=<?php echo $dados['cod_leilao']; ?>"><div class="btn_licitar_small" align="center" style="color:white; background-color:#3399ff; font-size:1em; position:relative; left:300px; line-height:100%;"><img src="src/topbar/check_ico.png" height="11" />&nbsp;&nbsp;Aprovar bid</div></a>
<a href="leiloes_eliminar.php?cod_leilao=<?php echo $dados['cod_leilao']; ?>"><div class="btn_licitar_small" align="center" style="color:white; background-color:#3399ff; font-size:1em; position:relative; left:310px; line-height:100%;"><img src="src/topbar/delete_ico.png" height="11" />&nbsp;&nbsp;Eliminar bid</div></a>
