...
<link href="file:///C|/xampp/htdocs/CMCALENDAR/loading.css" type="text/css" rel="stylesheet" />
<head>
...
if(!$cod_ttd == NULL){
 // delete the entry
 $result = mysql_query("INSERT into wishlist values ('','".$_SESSION['cod_user']."','".$cod_ttd."');")
 or die(mysql_error()); 
 } 
