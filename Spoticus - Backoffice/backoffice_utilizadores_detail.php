...
?>
	<table style="width:40%; position:absolute; margin-top:-20%; margin-left: 50%;">
			...
			<?php
			$user=$backoffice_inst->lista_users_p_cod($cod_user);
			$user_li=$user->fetch_assoc();
			$data_entrada = $user_li['data_reg'];
			...
			<tr>
				<td>Data de Entrada</td> <td> <?php printf($data_entrada); ?></td>
			</tr>
